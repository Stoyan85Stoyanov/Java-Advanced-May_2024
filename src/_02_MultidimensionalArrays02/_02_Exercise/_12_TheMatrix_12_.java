...
public class _12_TheMatrix_12_ {
    public static void main(String[] args) {
        ...
        String[] startRowAndCol = scanner.nextLine().split(" ");
    ...
    public static void readMatrix(int rows, int ignoredCols, Scanner scanner, Character[][] matrix) {
